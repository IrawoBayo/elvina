...
class ProfileController extends Controller
{
...

    {
        ...
        return back()->with('msg', 'Your Address is Successfully Updated');
...

    {
        ...
        if(!Hash::check($oldPassword,Auth::user()->password)) {
            ...
            return back()->with('msg', 'The specified old password does not match the existing password');

        }else{

            $request->user()->fill(['password'=>Hash::make($newPassword)])->save();

            return back()->with('msg','Password Successfully Updated');
